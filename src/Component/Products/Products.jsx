    ...
    <Container fluid className=' '>
      ...
      <MDBTabsContent>
        ...
        <Row className='pa-22'>
          ...
          <Row className='pa-22  mt-5'>
            <Col lg={3}>
              <img className='img-fluid  img-size' src={r2p4} alt="Image 5" />
            </Col>
            <Col lg={3}>
              <img className='img-fluid  img-size' src={r2p5} alt="Image 6" />
            </Col>
            <Col lg={3}>
              <img className='img-fluid   img-size' src={r2p6} alt="Image 7" />
            </Col>
          </Row>
        </MDBTabsPane>
        <MDBTabsPane open={justifyActive === 'tab3'}>
          ...
          <Row className='pa-22  mt-5'>
            ...
            <Col lg={3}>
              <img className='img-fluid   img-size' src={r3p8} alt="Image 7" />
            </Col>
          </Row>
        </MDBTabsPane>
