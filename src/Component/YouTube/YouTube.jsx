    ...
    <div className='container-fluid ad-you-back-img '>
      <div className='ad-you-back-content'>
        <div className='mt-5 mb-5'>
          ...
          <div>
            <p  className="i-cons-text-01"><HiOutlineMail className="i-cons-01" /> golden@gmail.com</p> {/* Using email icon */}
            <p  className="i-cons-text-01"><FaWhatsapp className="i-cons-01" /> (+91) 99887 74455</p>
